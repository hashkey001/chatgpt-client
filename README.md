...
```
{
  // Api Key From You OPENAI Console
  apiKey: '',
...
1. (deprecreted)Firstly, you should have an OpenAI account, then follow the steps below to get your token.
...
1. Go to your OPENAI console, get a api key
